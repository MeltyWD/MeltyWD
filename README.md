# 👋 Привет, меня зовут Портнягин Андрей,
## я надеюсь *Middle-frontend разработчик* 

### Планы и желания
+ Решать интересные задачи
+ Изучать новые технологии
+ Развиваться в сторону таймменеджмента и архитектур проектов
+ Развитие софт скиллов работы с командой 
+ В будущем целюсь на позицию TeamLead и взаимодествовать с командой
